...
INCS+=locales,tzdata,initramfs-tools,u-boot-tools,ca-certificates,haveged,zstd,isc-dhcp-client,isc-dhcp-server,ifupdown,uuidgen,
INCS+=btrfs-progs,i2c-tools,zram-tools,xz-utils,parted,openssl,rfkill,
INCS+=nano,curl,wget,file,unzip,iputils-ping,ethtool,
